      ...
      success: function (response) {
        ...
        response.forEach(function (item) {
          tableHtml +=
            ...
            "</td>";
          tableHtml +=
              '<td><button type="button" class="btn btn-sm btn-back-orange" onclick="window.open(\'http://localhost:8082/work-lounge/sharing-opinion/' + item.rndPlanNo + '\', \'mywindow\', \'width=1150, height=800,top=25, left=140, scrollbard=yes\')">의견공유</button></td>';
          tableHtml +=
            '<td><button type="button" class="btn btn-sm btn-back-indigo" onclick="window.open(\'http://localhost:8082/work-lounge/evaluation-paper/' + item.rndPlanNo + '\', \'mywindow\', \'width=900, height=685,top=25, left=250, scrollbard=no, resizable=no\')">평가</button></td></tr>';
        });
