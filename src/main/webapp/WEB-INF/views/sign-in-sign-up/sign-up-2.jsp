            ...
            <div class="change-tab-contents-area">
                ...
                <div class="terms-of-use-area">
                    <div class="terms-of-use-contents">
                        ...
                        2. 유지경성은 본 약관을 사전 고지없이 변경할 수 있고, 변경된 약관은 유지경성 내에 공지하거나 휴대전화 문자(장문자 포함) 또는 전자우편을 통해 회원에게 공지하며, 공지와 동시에 그 효력이
                        발생됩니다. 이용자가 변경된 약관에 동의하지 않는 경우, 이용자는 본인의 회원등록을 취소(회원탈퇴)할 수 있으며 계속 사용의 경우는 약관 변경에 대한 동의로 간주됩니다.</p>
                        ...
                        <p>
                            ...
                            4. 연구자회원 : 유지경성의 약관에 동의하고 국가연구자번호를 발급하여 보유하고 있는 회원으로 유지경성에서 제공하는 서비스를 이용하기 위하여 회원의 약관에 동의하고 연구자회원으로 전환한 회원<br>
