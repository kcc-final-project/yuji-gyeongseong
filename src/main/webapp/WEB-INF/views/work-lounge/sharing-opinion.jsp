                    ...
                    <div style="max-height: 400px; overflow-y: auto;">
                        <div class="card mb-2" style="max-height: 400px; overflow-y: auto;">
                            <div class="card-body d-flex flex-column justify-content-between">
                                ...
                                <p class="card-text">여기 게시글 내용이 나옵니다.</p>
                            ...
                            <div class="collapse" id="commentsSection">
                                <div class="card card-body mx-3 mt-2 mb-2">
                                    <div class="mb-3">
                                        <p>
                                        ...
                                        <div class="d-flex mb-1" id="contentWrapper1">
                                            ...
                                            <div class="w-100 p-2 bg-light border rounded text_area_div"
                                                ...
                                                <div class="form-group w-100">
                                                    <label for="postTitle"
                                                           class="font-weight-bold"><b>&nbsp;제목</b></label>
                                                    <input type="text" class="form-control title_area" id="postTitle1"
                ...
                <td colspan="6">
                    ...
                    <div class="d-flex mb-1" id="contentWrapper">
                        <div class="w-100 p-2 bg-light border rounded text_area_div" id="textareaDiv">
                            <div class="form-group w-100">
                                <label for="postTitle" class="font-weight-bold"><b>&nbsp;제목</b></label>
                                <input type="text" class="form-control title_area" id="postTitle"
                                       placeholder="게시글의 제목을 입력해주세요."/>
                            </div>
